...
export class JogoDaVelhaService {
  ...
  //Retorna se a tela de início deve sex exibida
  ...
  //Exibe o tanbuleiro. Depois de clicar no iniciar jogo
  iniciarJogo(): void {
...
//Retorna se a maracação de vitória deve ser exibida para a coordenada informada
